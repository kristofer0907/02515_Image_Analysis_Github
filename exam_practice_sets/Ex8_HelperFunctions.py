...
def preprocess_all_cats(in_dir, out_dir):
    ...
    """
    dst = "/home/kkristjansson/DTU/spring2026/02515_Image_Analysis/imageAnalysisGithub/exercises/ex8-CatsCatsCats/data/ModelCat"
    dst_lm = read_landmark_file(f"{dst}.jpg.cat")
    dst_img = io.imread(f"{dst}.jpg")

    all_images = glob.glob(in_dir + "*.cat")
    for cat_idx in all_images:
        # Strip both extensions: "foo.jpg.cat" -> "foo"
        name_no_ext = os.path.splitext(os.path.splitext(cat_idx)[0])[0]
        base_name = os.path.basename(name_no_ext)
        out_name = f"{out_dir}/{base_name}_preprocessed.jpg"

        src_lm = read_landmark_file(cat_idx)
...
def preprocess_one_cat():
    src = "/home/kkristjansson/DTU/spring2026/02515_Image_Analysis/imageAnalysisGithub/exercises/ex8-CatsCatsCats/data/MissingCat"
    dst = "/home/kkristjansson/DTU/spring2026/02515_Image_Analysis/imageAnalysisGithub/exercises/ex8-CatsCatsCats/data/ModelCat"
    out = "/home/kkristjansson/DTU/spring2026/02515_Image_Analysis/imageAnalysisGithub/exercises/ex8-CatsCatsCats/data/MissingCatProcessed.jpg"
...
def preprocess_one_cat_MY_OWN_VERSION():
    src = "/home/kkristjansson/DTU/spring2026/02515_Image_Analysis/imageAnalysisGithub/exercises/ex8-CatsCatsCats/data/Mycat"
    dst = "/home/kkristjansson/DTU/spring2026/02515_Image_Analysis/imageAnalysisGithub/exercises/ex8-CatsCatsCats/data/MissingCat"
    out = "/home/kkristjansson/DTU/spring2026/02515_Image_Analysis/imageAnalysisGithub/exercises/ex8-CatsCatsCats/data/MyCatProcessed.jpg"
